			...
			>
				<Box display="flex" gap={2} flexDirection={'column'} m="auto">
					...
					>
						...
						<Typography variant={'h3'} fontWeight={400} mt={3}>
							비슷한 고충을 겪고 있거나 극복한 스타트업
							대표님들과의 소통을 통해 문제를 해결하고 싶으신가요?
						</Typography>
						<Typography variant={'h3'} fontWeight={400} mb={5}>

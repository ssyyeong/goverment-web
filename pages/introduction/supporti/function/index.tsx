...
const Page: NextPage = () => {
	...
	// const getDates = (nowDate: Date, endDate: Date): string[] => {
	// 	if (nowDate > endDate) {
	// 		return [];
	// 	} else {
	// 		return [
	// 			formatDate(nowDate)!!,
	// 			...getDates(addDate(nowDate), endDate),
	// 		];
	// 	}
	// };
	...
	// const addMinute = (date: string, time: string, interval: number) => {
	// 	const dateTime = parseDateTime(`${date} ${time}`);
	// 	dateTime.setMinutes(dateTime.getMinutes() + interval);
	// 	return formatTime(dateTime);
	// };

	// const compareTime = (date: Date, firstTime: string, secondTime: string) => {
	// 	const dateString = formatDate(date);
	// 	const firstDateTime = parseDateTime(`${dateString} ${firstTime}`);
	// 	const secondDateTime = parseDateTime(`${dateString} ${secondTime}`);
	// 	return firstDateTime.getTime() - secondDateTime.getTime();
	// };

	// const [registerData, setRegisterData] = React.useState<any>(undefined);
	...
	// 	const addTime = addMinute(date, nowTime, interval);
	...
	// 			endTime: addTime,
	// 		},
	// 		...getTimes(date, addTime, endTime, interval),
	// 	];
	// };
	...
	// 	const eventPickUpTimeStates = getDates(startDate, endDate).flatMap(
	// 		(date) => {
	// 			console.log(date, registerData);
	// 			return getTimes(date, '14:00', '20:55', Number(20));
	// 		}
	// 	);

	// 	setRegisterData((prev) => ({
	// 		...prev,
	// 		times: eventPickUpTimeStates,
	// 	}));
	// };

	// React.useEffect(() => {
	// 	if (!registerData) handleCreateTimes();
	// }, []);

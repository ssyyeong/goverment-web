...
const Page: NextPage = () => {
	//* Constants
	const mainModelName = 'ProductReview';
	const subModelName = 'Product';

	const mainLabel = '상품 리뷰';
	const subLabel = '상품 정보';
	...
	const subModelController = new DefaultController(subModelName);
